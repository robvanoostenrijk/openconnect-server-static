...
do
    ...
    mkdir -p ./dist/bin ./dist/sbin ./dist/libexec
    ...
    XZ_OPT=-9 tar -C ./dist -Jcvf ./dist/openconnect-server-${PLATFORM//\//-}.tar.xz bin/occtl bin/ocpasswd libexec/ocserv-fw sbin/ocserv sbin/ocserv-worker
